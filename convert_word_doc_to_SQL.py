...
def clean(file):
    ...
    for title in clean_data:
        ...
        response_string = f"INSERT INTO question_groups_tb (Question_Number,fk_Question_Group_ID,Question_Text) VALUES ({Q_Num,Group_ID,text})\n"
        SQL_Command_Groups += response_string
